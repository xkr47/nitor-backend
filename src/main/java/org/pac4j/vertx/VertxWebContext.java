...
public class VertxWebContext implements WebContext {
    ...
    public VertxWebContext(final RoutingContext routingContext) {
        ...
        for (String name : request.headers().names()) {
            headers.put(name.toLowerCase(Locale.US), request.headers().get(name));
        }
    ...
    public String getRequestHeader(String name) {
        return headers.getString(name.toLowerCase(Locale.US));
    }
    ...
    public String getResponseHeader(String name) {
        return routingContext.response().headers().get(name);
    }
